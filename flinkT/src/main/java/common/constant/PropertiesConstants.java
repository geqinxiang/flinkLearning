 ...
 * @description:
 * @author: geqx
 * @create: 2020-11-26 10:55
 **/
public class PropertiesConstants {
//    public static final String ZHISHENG = "zhisheng";
    public static final String KAFKA_BROKERS = "kafka.brokers";
    public static final String DEFAULT_KAFKA_BROKERS = "192.168.0.116:9092";
    public static final String KAFKA_ZOOKEEPER_CONNECT = "kafka.zookeeper.connect";
    public static final String DEFAULT_KAFKA_ZOOKEEPER_CONNECT = "192.168.0.116:2181";
    public static final String KAFKA_GROUP_ID = "kafka.group.id";
    public static final String DEFAULT_KAFKA_GROUP_ID = "zy";
